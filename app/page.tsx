...
const faq = [
  ...
  {
    question: "Соколов детейлинг и Соколов детейл — это Сокольников Детейлинг?",
    answer:
      "Да. Правильное название сервиса — Сокольников Детейлинг. Если вы ищете Соколов детейлинг или Соколов детейл в Уфе, речь обычно идет о нашем выездном детейлинге авто с записью по телефону 8 999 764-24-44."
  }
];
    ...
    <main>
      ...
      <section className="section service-area">
        ...
        <p className="brand-note">
          Правильное название сервиса — Сокольников Детейлинг. Нас также могут
          искать как «Соколов детейлинг» или «Соколов детейл».
        </p>
        <address>
          <strong>Сокольников Детейлинг</strong>
